...
describe('maxBy', () => {
  ...
  it('should compare non-numeric values such as strings', () => {
    expect(maxBy([{ v: 'a' }, { v: 'b' }], o => o.v as unknown as number)).toEqual({ v: 'b' });
    expect(maxBy([{ v: 'b' }, { v: 'a' }], o => o.v as unknown as number)).toEqual({ v: 'b' });
  });
});
